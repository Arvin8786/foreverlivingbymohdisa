// =================================================================
// E-Shop Frontend Script - v21.1 (Final Upgraded)
// =================================================================

// ===========================================================
// [ 1.0 ] GLOBAL CONFIGURATION & STATE
// ===========================================================
const googleScriptURL = 'https://script.google.com/macros/s/AKfycbwsfCOrJjOesuIZ6gcAfYaMwGTnRoAFh6QikNTrFSBaY-zKBmnUXr2qgvK0riP5KaYifQ/exec';
...
        document.getElementById('update-timestamp').textContent = `${new Date().toLocaleDateString('en-GB')} (v21.1)`;
        
        // --- ADD EVENT LISTENERS ---
...
    try {
        const payload = {
            action: 'logInitialOrder', // *** FIX: Changed action name to match backend: logInitialOrder ***
            data: {
...
            }
        };
        // *** FIX: Response must now include the invoiceId ***
...
    try {
        // *** FIX: Removed redundant preflight fetch call. Browser handles OPTIONS request. ***
        
        const response = await fetch(googleScriptURL, {
            method: 'POST',
            mode: 'cors',
...
            ids: [33] 
        }, // *** FIX: Removed trailing comma here (Critical Syntax Fix) ***
