// =================================================================
// E-Shop Frontend Script - v27.0 (FINAL COMPLETE)
// Features: Themes, Marketing, Maintenance, Login, Cart
// =================================================================

// [ 1.0 ] GLOBAL CONFIGURATION
const googleScriptURL = 'https://script.google.com/macros/s/AKfycbycr_yrtuMOzcfE5ZVaevMNoycS9LqL7gmt37Biz7WPQLcVQkdHwktxJ0PVd09RuRBzfQ/exec';
...
async function fetchData() {
    try {
        ...
        if (marketing.MaintenanceMode === 'TRUE') {
            ...
            document.getElementById('maintenance-message').textContent = marketing.MaintenanceMessage || 'We are currently under maintenance.';
        ...
        document.getElementById('update-timestamp').textContent = `${new Date().toLocaleDateString('en-GB')} (v27.0)`;
...
async function initiateCheckout() {
    ...
    finally { btn.disabled = false; btn.textContent = 'Complete Order'; }
}
...
function applyTheme(theme) {
    ...
    // Default colors if theme not found in map
